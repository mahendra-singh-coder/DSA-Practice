...
void InsertNodeBeforeData()
{
	int data,pos=1;
	printf("\nEnter data of node which you want to insert before it : ");
	scanf("%d",&data);
	Node *temp=start;
	...
	if(temp==NULL)
	{
		printf("\nData doesn't match Insertion FAiled...");
	}
	else
	{
		InsertGivenNode(pos);
